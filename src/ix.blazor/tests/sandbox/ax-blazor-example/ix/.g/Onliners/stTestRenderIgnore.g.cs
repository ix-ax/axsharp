...
public partial class stTestRenderIgnore : Ix.Connector.ITwinObject
{
    [RenderIgnore()]
    ...
    public stTestRenderIgnore(Ix.Connector.ITwinObject parent, string readableTail, string symbolTail)
    {
