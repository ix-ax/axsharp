...
public partial class TestStructWithMainLayout : Ix.Connector.ITwinObject
{
    ...
    public TestStructWithMainLayout(Ix.Connector.ITwinObject parent, string readableTail, string symbolTail)
    {
