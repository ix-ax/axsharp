...
public partial class stTestMultipleNested : Ix.Connector.ITwinObject
{
    ...
    public OnlinerString Servo_S3 { get; }

    public OnlinerString Servo_S4 { get; }

    public stTestMultipleNested(Ix.Connector.ITwinObject parent, string readableTail, string symbolTail)
    {
        ...
        Servo_S3 = @Connector.ConnectorAdapter.AdapterFactory.CreateSTRING(this, "Servo S3", "Servo_S3");
        Servo_S3.AttributeName = "Servo S3";
        Servo_S4 = @Connector.ConnectorAdapter.AdapterFactory.CreateSTRING(this, "Servo S4", "Servo_S4");
        Servo_S4.AttributeName = "Servo S4";
        parent.AddChild(this);
        parent.AddKid(this);
    }

    public async Task<Pocos.stTestMultipleNested> OnlineToPlainAsync()
    {
        Pocos.stTestMultipleNested plain = new Pocos.stTestMultipleNested();
        ...
        plain.Servo_S3 = Servo_S3.LastValue;
        plain.Servo_S4 = Servo_S4.LastValue;
        return plain;
    }

    protected async Task<Pocos.stTestMultipleNested> OnlineToPlainAsync(Pocos.stTestMultipleNested plain)
    {
        plain.Servo_S5 = await Servo_S5.OnlineToPlainAsync();
        plain.Servo_S6 = await Servo_S6.OnlineToPlainAsync();
        plain.Servo_S7 = await Servo_S7.OnlineToPlainAsync();
    ...
    public async Task<IEnumerable<ITwinPrimitive>> PlainToOnlineAsync(Pocos.stTestMultipleNested plain)
    {
        ...
        Servo_S3.Cyclic = plain.Servo_S3;
        Servo_S4.Cyclic = plain.Servo_S4;
