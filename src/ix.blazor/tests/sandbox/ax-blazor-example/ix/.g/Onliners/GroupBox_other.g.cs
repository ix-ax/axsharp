...
public partial class GroupBox_other : Ix.Connector.ITwinObject
{
    ...
    public GroupBox_other(Ix.Connector.ITwinObject parent, string readableTail, string symbolTail)
    {
        ...
        Servo_S1 = new TestStructOneGroupWithLayout(this, "Servo S1", "Servo_S1");
    ...
    public async Task<Pocos.GroupBox_other> OnlineToPlainAsync()
    {
        Pocos.GroupBox_other plain = new Pocos.GroupBox_other();
        await this.ReadAsync();
        plain.B1 = B1.LastValue;
        plain.B2 = B2.LastValue;
        ...
        plain.Servo_S1 = await Servo_S1.OnlineToPlainAsync();
        plain.Servo_S2 = Servo_S2.LastValue;
        return plain;
    }

    protected async Task<Pocos.GroupBox_other> OnlineToPlainAsync(Pocos.GroupBox_other plain)
    {
        plain.B1 = B1.LastValue;
        plain.B2 = B2.LastValue;
        plain.Piston_A1 = Piston_A1.LastValue;
    ...
    public async Task<IEnumerable<ITwinPrimitive>> PlainToOnlineAsync(Pocos.GroupBox_other plain)
    {
        B1.Cyclic = plain.B1;
        B2.Cyclic = plain.B2;
        ...
        await this.Servo_S1.PlainToOnlineAsync(plain.Servo_S1);
