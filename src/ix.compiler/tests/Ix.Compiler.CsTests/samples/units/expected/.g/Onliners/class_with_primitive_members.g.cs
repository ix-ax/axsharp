...
{
    public partial class ClassWithPrimitiveTypes : Ix.Connector.ITwinObject
    {
        ...
        public ClassWithPrimitiveTypes(Ix.Connector.ITwinObject parent, string readableTail, string symbolTail)
        {
