...
namespace CompilerOmmits
{
    public partial class ClassWithArrays : Ix.Connector.ITwinObject
    {
        ...
        protected async Task<Pocos.CompilerOmmits.ClassWithArrays> OnlineToPlainAsync(Pocos.CompilerOmmits.ClassWithArrays plain)
        {
            plain._primitive = _primitive.Select(p => p.LastValue).ToArray();
            return plain;
        }
        ...
        {
            this.PlainToOnlineAsync((Pocos.CompilerOmmits.ClassWithArrays)plain).Wait();
        }
        ...
        {
            this.PlainToShadowAsync((Pocos.CompilerOmmits.ClassWithArrays)plain).Wait();
        }
    ...
    public partial class Complex : Ix.Connector.ITwinObject
    {
        ...
        protected async Task<Pocos.CompilerOmmits.Complex> OnlineToPlainAsync(Pocos.CompilerOmmits.Complex plain)
        {
            plain.HelloString = HelloString.LastValue;
            plain.Id = Id.LastValue;
            return plain;
        ...
        public void PlainToOnline(object plain)
        {
            this.PlainToOnlineAsync((Pocos.CompilerOmmits.Complex)plain).Wait();
        }
        ...
        public void PlainToShadow(object plain)
        {
            this.PlainToShadowAsync((Pocos.CompilerOmmits.Complex)plain).Wait();
        }
