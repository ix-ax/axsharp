...
namespace Simatic.Ax.StateFramework
{
    ...
    {
        public State1Transition(Ix.Connector.ITwinObject parent, string readableTail, string symbolTail) : base(parent, readableTail, symbolTail)
        {
...
namespace Simatic.Ax.StateFramework
{
    public partial class AbstractState : Ix.Connector.ITwinObject, IState, IStateMuteable
    {
        ...
        public AbstractState(Ix.Connector.ITwinObject parent, string readableTail, string symbolTail)
        {
            ...
            StateID = @Connector.Online.AdapterFactory.CreateINT(this, "StateID", "StateID");
            StateName = @Connector.Online.AdapterFactory.CreateSTRING(this, "StateName", "StateName");
            parent.AddChild(this);
            parent.AddKid(this);
        }
