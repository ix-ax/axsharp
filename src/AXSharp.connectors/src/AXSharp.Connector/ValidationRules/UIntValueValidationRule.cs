...
/// <summary>
///     Provides validation rule for <see cref="OnlinerUInt" /> type.
/// </summary>
public class UIntValueValidationRule : OnlinerValidationRule<ushort>
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="UIntValueValidationRule" /> class.
    /// </summary>
    /// <param name="onliner">
    ///     Onliner type.
    /// </param>
    public UIntValueValidationRule(OnlinerUInt onliner) : base(onliner)
    {
    }

    /// <summary>
    ///     Validates value of <see cref="OnlinerUInt" />
    /// </summary>
