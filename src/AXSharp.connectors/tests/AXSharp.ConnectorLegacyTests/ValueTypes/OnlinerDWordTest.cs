...
namespace AXSharp.Connector.Onliners.Tests
{
    ...
    public class OnlinerDWordTest : OnlinerBaseTests<uint>
    {
        ...
        {
            Onliner = new OnlinerDWord(new TestTwinObject(), $"readableTail", "symbolTail");
        }
        ...
        {
            //-- Arrange
            var min = OnlinerDWord.MinValue;
            var max = OnlinerDWord.MaxValue;
            var mid = OnlinerDWord.MaxValue / 2;
        ...
        public void ValidateOverShootRangePresetTest()
        {
            ...
            Onliner.AttributeMinimum = OnlinerDWord.MinValue + 1;
            Onliner.AttributeMaximum = OnlinerDWord.MaxValue - 1;
            //-- Arrange
            var min = OnlinerDWord.MinValue;
            var max = OnlinerDWord.MaxValue;
        ...
        {
            var expected = OnlinerDWord.MaxValue / 2;
