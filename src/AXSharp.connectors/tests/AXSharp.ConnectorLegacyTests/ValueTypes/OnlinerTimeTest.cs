...
namespace AXSharp.Connector.Onliners.Tests
{
    ...
    public class OnlinerTimeTest : OnlinerBaseTests<TimeSpan>
    {
        ...
        {
            Onliner = new OnlinerTime(new TestTwinObject(), $"readableTail", "symbolTail");
        }
        ...
        public void ChangeEditedValueTest()
        {
            ...
            var expected = OnlinerTime.MaxValue;
        ...
        {
            //-- Arrange
            var min = OnlinerTime.MinValue;
            var max = OnlinerTime.MaxValue;
            var mid = (OnlinerTime.MaxValue / 2);
        ...
        {
            var expected = TimeSpan.FromHours(44);
