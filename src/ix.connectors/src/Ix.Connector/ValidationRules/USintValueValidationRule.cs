...
/// <summary>
///     Provides validation rule for <see cref="OnlinerUSInt" /> type.
/// </summary>
public class USintValueValidationRule : OnlinerValidationRule<byte>
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="USintValueValidationRule" /> class.
    /// </summary>
    /// <param name="onliner">
    ///     Onliner type.
    /// </param>
    public USintValueValidationRule(OnlinerUSInt onliner) : base(onliner)
    {
    }

    /// <summary>
    ///     Validates value of <see cref="OnlinerUSInt" />
    /// </summary>
