...
/// <summary>
///     Provides validation rule for <see cref="OnlinerWord" /> type.
/// </summary>
public class WordValueValidationRule : OnlinerValidationRule<ushort>
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="WordValueValidationRule" /> class.
    /// </summary>
    /// <param name="onliner">
    ///     Onliner type.
    /// </param>
    public WordValueValidationRule(OnlinerWord onliner) : base(onliner)
    {
    }

    /// <summary>
    ///     Validates value of <see cref="OnlinerWord" />
    /// </summary>
