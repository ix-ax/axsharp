...
namespace ax_blazor_1
{
    public partial class GeoLocation : Ix.Connector.ITwinObject
    {
        ...
        public GeoLocation(Ix.Connector.ITwinObject parent, string readableTail, string symbolTail)
        {
            ...
            Latitude = new OnlinerReal(this, "", "Latitude");
            Longitude = new OnlinerReal(this, "", "Longitude");
            Altitude = new OnlinerReal(this, "", "Altitude");
            Description = new OnlinerString(this, "", "Description");
