...
public partial class groupbox : Ix.Connector.ITwinObject
{
    ...
    public groupbox(Ix.Connector.ITwinObject parent, string readableTail, string symbolTail)
    {
    ...
    public Pocos.groupbox OnlineToPlain()
    {
    ...
    public void PlainToOnline(Pocos.groupbox plain)
    {
